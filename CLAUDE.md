...
5. Bundled skins: NeonWave (default, sprite-based title text generated by `scripts/generate_neonwave_title_sprites.swift`), StereoGear (image-based reference with pixel art sprites, generated by `scripts/generate_stereo_skin.swift`)
6. See [AGENT_DOCS/MODERN_SKIN_GUIDE.md](AGENT_DOCS/MODERN_SKIN_GUIDE.md) for full docs
